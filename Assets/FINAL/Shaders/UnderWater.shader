...
Shader "UnderWater"
{
	Properties
	{
		_UnderWaterColor("UnderWater Color", Color) = (0.4811321,0.07489321,0.08307241,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag (ASEVaryingsDefault i  ) : SV_Target
			{
				...
				float4 color = ( tex2D( _MainTex, saturate( ( uv_MainTex + ( 0.01311184 * ( simplePerlin2D16 + simplePerlin2D21 ) ) ) ) ) + ( _UnderWaterColor * 0.5 ) );
...
/*ASEBEGIN
Version=18900
0;590;1591;401;692.8601;101.6976;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;54;105.6975,-94.85476;Inherit;False;Property;_UnderWaterColor;UnderWater Color;0;0;Create;True;0;0;0;False;0;False;0.4811321,0.07489321,0.08307241,0;0,0.8713033,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;56;103.6489,82.35926;Inherit;False;Constant;_WaterColorIntensity;Water Color Intensity;0;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1A1733D4DAE7C93858257E52A60EFC5AFFFF6C0E